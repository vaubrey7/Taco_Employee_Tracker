...
// allows selecting of employee by "first name" instead if "first_name" or "Deparment" instead of "deparment_name" etc.
...
const showAll = () => {
  connection.query(allEmployeeQuery, (err, results) => {
      if (err) throw err;
      console.log(' ');
      console.table(taco.bold.yellow('All Employees'), results)
      startApp();
  })
}

// show employees, filtered by department, then you can select by id, first name, last name, salary, etc. 
const showByDept = () => {
  ...
  connection.query(deptQuery, (err, results) => {
      ...
      inquirer.prompt([
          ...
          connection.query(query, { department_name: chosenDept.department_name }, (err, res) => {
              if (err) throw err;
              console.log(' ');
              console.table(taco.bold.yellow(`All Employees by Department: ${chosenDept.department_name}`), res)
              startApp();
          })
      })
  })
  ...
  connection.query(mgrQuery, (err, results) => {
      ...
      inquirer.prompt([
          ...
          connection.query(mgrQuery2, [answer.mgr_choice], (err, results) => {
              if (err) throw err;
              console.log(' ');
              console.table(taco.bold.yellow('Employees by Manager'), results);
              startApp();
          })
      })
  })
...
const viewRoles = () => {
  ...
  connection.query(query, (err, results) => {
      ...
      console.log(' ');
      console.table(taco.bold.yellow('All Roles'), results);
      startApp();
  })
...
const addRole = () => {
  ...
  connection.query(addRoleQuery, (err, results) => {
      if (err) throw err;
      console.log('');
      console.table(taco.bold.yellow('List of current Roles:'), results[0]);
      inquirer.prompt([
          {
              name: 'newSalary',
              type: 'input',
...
const viewDept = () => {
  ...
  connection.query(query, (err, results) => {
      if (err) throw err;
      console.log('');
      console.table(taco.bold.yellow('All Departments'), results)
      startApp();
  })
}
...
const addDept = () => {
  ...
  connection.query(query, (err, results) => {
      if (err) throw err;
      console.log('');
      console.table(taco.bold.yellow('List of current Departments'), results);
      inquirer.prompt([
          {
              name: 'newDept',
              type: 'input',
